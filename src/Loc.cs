...
namespace HacknetAccess
{
    ...
    public static class Loc
    {
        private static readonly Dictionary<string, string> _strings = new Dictionary<string, string>
        {
            ...
            { "db.entry", "Record: {0}" },
            { "db.degree", "Degree: {0}" },
            { "db.notFound", "No results found. Enter or Escape to return to menu." },
            { "db.multiMatch", "{0} matches found. Up/Down to navigate, Enter to select." },
            { "db.matchItem", "Match {0} of {1}: {2}" },
            { "db.medicalMain", "Medical Database menu. Enter to search, R for random entry, I for info, Escape to exit." },
            { "db.medicalSearchPrompt", "Type patient last name, then Enter to search. Escape to cancel." },
            { "db.medicalInfo", "Database info screen. Escape to return to menu." },
            { "db.medicalSend", "Send record menu. Enter to specify recipient address, Escape to return." },
            { "db.medicalSendPrompt", "Type recipient email, then Enter to send. Escape to cancel." },
            { "db.medicalSendDone", "Record sent. Enter to send to a different address, Escape to return to menu." },
            { "db.genericWelcome", "{0}. Enter to browse records, L to login, Escape to exit." },
            { "db.genericWelcomeNoAccess", "{0}. Administrator login required. L to login, Escape to exit." },
            { "db.genericBrowse", "{0} record(s). Up and Down to navigate, Enter to view, Escape to go back." },
            { "db.genericBrowseEmpty", "No records. Escape to go back." },
            { "db.genericRecord", "Record {0} of {1}: {2}" },
